...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildPageMetadata(PAGE_PATH, pageHeroSettings, settings, {
    title: "Home Loans for Nurses & Midwives in Australia | Mortgage Xperts",
    description:
      "Special home loan benefits and LMI waivers for nurses, midwives, and healthcare professionals in Australia.",
    keywords: [
    ...
    imageAlt: "Home Loans for Nurses and Healthcare Professionals",
  });
}
...
export default async function Page() {
  ...
  const jsonLd = buildJsonLd(
    "Home Loans for Nurses - Mortgage Xperts",
