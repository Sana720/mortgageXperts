          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-6 flex justify-end no-print">
              <div className="w-full max-w-[500px] bg-gradient-to-b from-white via-white to-slate-50/50 border border-slate-200/60 rounded-[32px] p-8 shadow-[0_32px_64px_-16px_rgba(15,23,42,0.08)] hover:shadow-[0_32px_64px_-16px_rgba(15,23,42,0.12)] flex flex-col justify-between min-h-[510px] transition-all duration-300 relative overflow-hidden">
                ...
                {currentStep === 3 && (
                  <form onSubmit={handleLeadSubmit} className="space-y-4 py-2">
                    <div className="bg-emerald-50/50 border border-emerald-100 rounded-2xl p-4 text-center">
                      <h4 className="text-[#0B1F3A] font-extrabold text-[13px] font-montserrat">Unlock Savings Target Report</h4>
                      <p className="text-[11px] text-slate-500 mt-1">Enter your details to generate your detailed deposit timeline and download it as a PDF.</p>
                    </div>
                ...
                {/* BOTTOM BUTTON BAR FOR STEP 1, 2 & 3 */}
                {currentStep < 4 && (
                  <div className="flex justify-between items-center gap-3 border-t border-slate-100 pt-4 mt-4">
                    ...
                    {currentStep < 3 ? (
                      ...
                      <button
                        ...
                        className="flex-1 bg-gradient-to-r from-emerald-600 to-teal-500 hover:from-emerald-700 hover:to-teal-600 text-white font-extrabold text-[13px] py-3 rounded-full flex items-center justify-center gap-1.5 cursor-pointer shadow-md shadow-emerald-500/10 transition-colors ml-auto"
                      >
                        {calcLeadSubmitting ? "Generating Report..." : "Generate Savings Report"}
                      </button>
                    )}
                  </div>
                )}
                ...
                <form onSubmit={handleGuideSubmit} className="space-y-3.5">
                  <div className="grid grid-cols-1 gap-3">
                    <input
                      ...
                      className="w-full bg-white/5 border border-white/10 rounded-xl px-3.5 py-2.5 text-xs font-semibold focus:outline-none focus:border-emerald-400 focus:bg-white/10 text-white placeholder-slate-500 transition-all"
                    />
                    <input
                      type="email"
                      required
            ...
            <div className="bg-white/5 backdrop-blur-md border border-white/10 p-8 rounded-3xl w-full">
              {enquirySubmitted ? (
                <div className="text-center py-12 space-y-4">
                  <div className="w-14 h-14 rounded-full bg-[#10B981]/10 text-emerald-400 flex items-center justify-center mx-auto border border-[#10B981]/25">
                    <CheckCircle2 className="w-7 h-7" />
                  </div>
                  <h3 className="text-lg font-black font-montserrat">Callback Request Received</h3>
                  <p className="text-xs text-slate-355 leading-relaxed max-w-xs mx-auto">
                ...
                <form onSubmit={handleEnquirySubmit} className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-extrabold text-[13px] py-3.5 px-6 rounded-xl transition-all shadow-lg shadow-emerald-500/10 active:scale-[0.98] mt-2"
                  >
