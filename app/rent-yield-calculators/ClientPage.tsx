                      ...
                      {expenseMode === 'simple' ? (
                        <div className="space-y-1 relative">
                          ...
                          <input
                            ...
                            className="w-full bg-slate-50/80 border border-slate-200/80 rounded-2xl pl-8 pr-4 py-2.5 text-[13px] font-extrabold text-[#0B1F3A] focus:outline-none focus:bg-white focus:border-teal-500 transition-all"
                          />
                        </div>
                      ) : (
                        <div className="grid grid-cols-2 gap-2 max-h-[160px] overflow-y-auto p-1 border border-slate-150 rounded-xl bg-white/50">
                          <div className="space-y-1">
                            ...
                            <input
                              ...
                              className="w-full bg-slate-50 border border-slate-200 rounded-lg px-2.5 py-1.5 text-[11px] font-bold text-[#0B1F3A] focus:outline-none focus:border-teal-500"
                            />
                          </div>
                          <div className="space-y-1">
                ...
                {currentStep === 2 && (
                  <form onSubmit={handleLeadSubmit} className="space-y-4 py-2">
                    <div className="bg-teal-50/50 border border-teal-100 rounded-2xl p-4 text-center">
                      <h4 className="text-[#0B1F3A] font-extrabold text-[13px] font-montserrat">Unlock Rental Yield Report</h4>
                      <p className="text-[11px] text-slate-500 mt-1">Enter your details to generate your comprehensive gross & net rental yield assessment and download the PDF report.</p>
                    </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full bg-slate-50 border border-slate-200 rounded-xl pl-10 pr-4 py-2.5 text-xs font-semibold focus:outline-none focus:border-teal-500"
                        />
                      </div>
                    </div>
                ...
                {currentStep < 3 && (
                  <div className="flex justify-between items-center gap-3 border-t border-slate-100 pt-4 mt-4">
                    ...
                    {currentStep === 1 ? (
                      ...
                      >
                        Next: Calculate Yield <ArrowRight className="w-4 h-4" />
                      </button>
                    ) : (
                      <button
                        type="button"
            ...
            <div className="bg-white/5 backdrop-blur-md border border-white/10 p-6 rounded-2xl max-w-md lg:ml-auto w-full">
              {guideSubmitted ? (
                <div className="text-center py-8 space-y-3">
                  ...
                  <p className="text-xs text-slate-300 leading-relaxed">Your guide has been sent to your email. One of our property investment mortgage specialists will follow up with you shortly.</p>
                </div>
              ) : (
                <form onSubmit={handleGuideSubmit} className="space-y-3.5">
                  <div className="grid grid-cols-1 gap-3">
                    <input
                      ...
                      className="w-full bg-white/5 border border-white/10 rounded-xl px-3.5 py-2.5 text-xs font-semibold focus:outline-none focus:border-teal-400 focus:bg-white/10 text-white placeholder-slate-500 transition-all"
                    />
                    <input
                      type="email"
                      required
