          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-6 space-y-6 no-print order-2 lg:order-1">
              ...
              <p className="text-slate-550 text-[14px] sm:text-[14.5px] leading-relaxed max-w-xl font-medium">
                {pageSections?.[0] || pageContent || `Mortgage interest compounding can be tackled by paying extra amounts weekly, fortnightly, or monthly. Input your current terms and see how much interest and time you will save.`}
              </p>
