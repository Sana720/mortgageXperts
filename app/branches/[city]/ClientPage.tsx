    ...
    <div className="min-h-screen flex flex-col bg-white font-inter" style={{ overflowX: "clip" }}>
      ...
      >
        ...
        <div className="relative z-10 max-w-[1440px] mx-auto px-6 md:px-10 lg:px-16 w-full">
          {/* Breadcrumbs */}
          <nav aria-label="Breadcrumb" className="flex items-center gap-2 bg-slate-50 border border-slate-200/60 rounded-full px-4 py-2 w-fit mb-8 text-[11.5px] font-bold text-slate-500 shadow-xs">
