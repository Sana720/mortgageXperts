...
export default function FreeResource2Client() {
  return (
    <div className="bg-[#F0F4FA] min-h-screen font-sans flex flex-col">
      <SiteHeader isSticky={false} />

      <SubPageHero
        pageTitle="Step By Step Home Buying Process"
        themeColor="violet"
        pageHeroSettings={{
          hero_badge: "Free Resource",
          hero_title: "Home Buying Process",
          hero_subtext: "A visual flowchart and guide detailing the exact timeline and process of buying a home in Australia, ensuring you never miss a deadline.",
          hero_image: "/images/hero.png",
          hero_btn1_text: "Download Process Guide",
          hero_btn1_link: "/assets/step-by-step-home-buying-process.pdf",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-[15px] sm:text-[16px] text-slate-600 leading-relaxed mb-8">
              From contract clauses to cooling off periods, the Australian property timeline is incredibly strict. 
              Use our flowchart to ensure you are completely prepared for settlement day.
            </p>
            ...
            <div className="bg-white rounded-3xl p-8 md:p-10 border border-slate-200 shadow-xl relative overflow-hidden">
              ...
              <ul className="space-y-5 mb-8 relative z-10">
                {[
                  "Understanding contract clauses (Subject to finance, pest, etc.)",
                  "The role of your conveyancer vs your broker",
                  "Cooling off periods and unconditional approval",
                  "What happens between unconditional approval and settlement",
              ...
              <a 
                href="/assets/step-by-step-home-buying-process.pdf" 
                target="_blank"
          ...
          <div className="relative rounded-3xl overflow-hidden shadow-2xl h-[400px] sm:h-[500px] lg:h-[650px]">
            <img
              ...
              alt="Reviewing home buying process"
