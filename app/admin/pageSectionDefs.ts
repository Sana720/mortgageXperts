...
export const PAGE_SECTION_DEFS: Record<string, SectionDef[]> = {
  ...
  "/": [
    { label: "Section 0 — Why Choose Us Section Title", hint: "Why Choose Mortgage Xperts?", multiline: false, defaultValue: "Why Choose Mortgage Xperts?" },
    { label: "Section 1 — Why Choose Us Intro Paragraph", hint: "Intro text under section title", multiline: true, defaultValue: "We deliver personalised lending strategies for health professionals and property investors across Australia. Whether you're purchasing your first home or building a portfolio, we have you covered." },
    { label: "Section 2 — Card 1: City name", hint: "Sydney", multiline: false, defaultValue: "Sydney" },
    { label: "Section 3 — Card 1: Title", hint: "Mortgage Broker in Sydney", multiline: false, defaultValue: "Mortgage Broker in Sydney" },
    { label: "Section 4 — Card 1: Description", hint: "SEO optimized description", multiline: true, defaultValue: "Expert mortgage broker in Sydney helping health professionals, first home buyers and property investors secure the right home loan with tailored lending strategies." },
    { label: "Section 5 — Card 2: City name", hint: "Adelaide", multiline: false, defaultValue: "Adelaide" },
    { label: "Section 6 — Card 2: Title", hint: "Mortgage Broker in Adelaide", multiline: false, defaultValue: "Mortgage Broker in Adelaide" },
    { label: "Section 7 — Card 2: Description", hint: "SEO optimized description", multiline: true, defaultValue: "Mortgage Xperts serves health professionals and investors in Adelaide with expert home loan and refinancing solutions. Personalised guidance to navigate Australia's complex mortgage market." },
    { label: "Section 8 — Card 3: City name", hint: "Melbourne", multiline: false, defaultValue: "Melbourne" },
    { label: "Section 9 — Card 3: Title", hint: "Mortgage Broker in Melbourne", multiline: false, defaultValue: "Mortgage Broker in Melbourne" },
    { label: "Section 10 — Card 3: Description", hint: "SEO optimized description", multiline: true, defaultValue: "Trusted mortgage broker in Melbourne helping doctors, nurses, allied health professionals and property investors get personalised home loan solutions, refinancing advice and investment finance." },
    { label: "Section 11 — Card 4: City name", hint: "Brisbane", multiline: false, defaultValue: "Brisbane" },
    { label: "Section 12 — Card 4: Title", hint: "Mortgage Broker in Brisbane", multiline: false, defaultValue: "Mortgage Broker in Brisbane" },
    { label: "Section 13 — Card 4: Description", hint: "SEO optimized description", multiline: true, defaultValue: "Mortgage Xperts Brisbane specialises in home loans, refinancing, and investment finance for health professionals and property investors, backed by hundreds of satisfied clients." }
  ]
};
