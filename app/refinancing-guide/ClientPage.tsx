...
export default function RefinancingGuideClient() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-[15px] sm:text-[16px] text-slate-600 leading-relaxed mb-8">
              Banks rarely reward loyalty. Our refinancing guide teaches you how to leverage your equity, 
              negotiate lower rates, and consolidate debt to regain financial freedom.
            </p>
            ...
            <div className="bg-white rounded-3xl p-8 md:p-10 border border-slate-200 shadow-xl relative overflow-hidden">
              ...
              <a 
                href="/assets/refinancing-guide.pdf" 
                target="_blank"
